...
window._skel_config = {
    ...
    grid: {gutters: 30},
     breakpoints: {
		...
		narrow: { range: '701-1199', containers: 960 },
		narrower: { range: '701-960', containers: 'fluid' },
		mobile: { range: '-700', containers: 'fluid', lockViewport: true, grid: { collapse: true, gutters: 20 } }
	}
};
