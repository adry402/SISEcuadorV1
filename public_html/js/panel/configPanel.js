...
window._skel_config = {
    ...
    grid: {gutters: 30},
     breakpoints: {
		...
		narrow: { range: '601-1199', containers: 960 },
		narrower: { range: '601-960', containers: 'fluid' },
		mobile: { range: '-600', containers: 'fluid', lockViewport: true, grid: { collapse: true, gutters: 20 } }
	}
};
